        ...
        while (true) {
            ...
            for (int i = 0; i < sz; ++i) {
                ...
                int offset = lookup(entry->u.procEntry.localTable,
                                    parameterDeclarationListGet(procDec->u.procedureDeclaration.parameters,
            ...
            ParameterDeclaration *parDec = parameterDeclarationListGet(procDec->u.procedureDeclaration.parameters,
                                                                       index);
